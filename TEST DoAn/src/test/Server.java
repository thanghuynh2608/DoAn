...
static JTextArea content; // Khai báo ô nhập nội dung chat
    ...
    public static void main(String[] args)
    {
          ...
          try
          {
              ...
              {
            	 //BufferedReader: Luồng ra vào ký tự 
 ...
 public Server() {
        ...
        content.setBackground(Color.white); // Định nghĩa ô nền nội dung
        ...
        toName = new JTextField("Host: "+ adr);  // Đặt nội dung yêu cầu mặc định
