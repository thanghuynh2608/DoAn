...
public class Client extends JFrame implements ActionListener{
    ...
    public static void main(String[] args) {
     ...
     public Client() { 
            ...
            content.setBackground(Color.white); // Đặt hình nền
            ...
            toName = new JTextField("Client"); // Định nghĩa nội dung mặc định cho khung
            toName.setFont(f); // Đặt font cho khung
            toName.setBackground(Color.white); // Đặt nền cho khung
